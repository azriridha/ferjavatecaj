...
public class InstrDecrement implements Instruction {
	...
	{
		if (arguments.size() != 1)
			throw new IllegalArgumentException("DECREMENT: Expected 1 argument");
		if (!arguments.get(0).isRegister())
			throw new IllegalArgumentException("DECREMENT: Type mismatch for argument 0");
	...
	public boolean execute(Computer computer) {
		...
		if (!(value instanceof Integer))
			throw new ClassCastException("DECREMENT: u registru " + indexRx + " se ne nalazi broj");
